...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2017 at 01:41 PM
...
CREATE TABLE `profiles` (
  ...
  `tahun_ajaran` tinyint(2) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(61, 'REG061', 'asem', '', '0000-00-00', NULL, '', 0, 0, '', NULL, 'sekolah', '', 0, '', '', '', '0', 0, 0, '', '', '1509599459_logolidi.jpeg', 'Belum Lengkap', 'Belum Diverifikasi', 'Tidak Lulus', 1, '2017-10-24 00:11:28', '2017-11-02 05:10:59'),
...
(69, 'Khihady Sucahyo', 'khihady.ks@gmail.com', 1, '$2y$10$/mhg0.7l65RsUXV2i.dUyO3NfOFtpzhsKhuAPoSLF0F3bbIsjXO/2', 'njFvftKFfeC94vS4gV7EvlOxrSaFNOx9MYEhFLdire66CkBHomysz4X3j2nK', '2017-11-02 02:39:23', '2017-11-02 02:39:23'),
...
--
ALTER TABLE `pesans`
  MODIFY `id_pesan` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
--
