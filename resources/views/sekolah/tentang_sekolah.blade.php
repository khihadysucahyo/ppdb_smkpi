              ...
              <form class="form-horizontal" role="form" method="post" action="/tentang_sekolah" enctype="multipart/form-data">
                  ...
                  <div class="row">
                      <div class="input-field col s12">
                          <textarea  id="teks" name="teks" class="materialize-textarea" >@if($errors->has('teks')) {{old('teks')}}@else{{$tentang_sekolah->teks}}@endif</textarea>
                      </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="file-field input-field col s7">
                      <div class="btn">
                        ...
                        <input type="hidden" name="tmp_lampiran" value="{{$tentang_sekolah->lampiran}}">
                      </div>
